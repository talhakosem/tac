...
<form method="post" action="fiyat-hesapla.php">
 ...
 <br> <br>
  ...
  <label for="duba_deger">Duba çapı:</label>
    ...
    <option value="5.49">Q90</option>
    <option value="8.16">Q110</option>
    <option value="10.42">Q125</option>
    <option value="15.42">Q140</option>
    <option value="17.1">Q160</option>
    <option value="21.57">Q180</option>
    <option value="27">Q200</option>
  </select>

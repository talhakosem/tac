...
<div class="container">
  <form action="islemler/islem.php" method="POST"  enctype="multipart/form-data"  data-parsley-validate>
    <div class="form-row">
      ...
      <div class="form-group col-md-6">
        <label>E-Posta</label>
        <input type="text" required class="form-control" disabled value="<?php echo $kullanicicek['kul_mail'] ?>" name="kul_mail" placeholder="E-Mail">
      </div>
    </div>
    <div class="form-row">
      <div class="form-group col-md-6">
    ...
    <div class="form-row">
      ...
      <div class="col-md-6 mb-3">
        ...
        <input type="text" class="form-control" disabled name="kul_sifre" placeholder="Şifre">
      </div>
      <div class="col-md-6 mb-3">
        <label>Profil Resmi</label>
        <div class="file-loading">
          <input class="form-control" disabled id="profilresmi" name="kul_logo" type="file">
        </div>
      </div>

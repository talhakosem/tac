...
<div class="col-lg-12">
    ...
    <div class="pb-md-2">
        ...
        <ul>
            ...
            <li><strong>Sürdürülebilir Çözümler Sunmak:</strong> Dayanıklı ve tekrar kullanılabilir esnek bariyerler üreterek, uzun vadede ekonomik ve çevresel sürdürülebilirliği desteklemek.</li>
            <li><strong>Müşteri Memnuniyetini En Üst Düzeyde Tutmak:</strong> Müşterilerimizin ihtiyaçlarına hızlı ve etkin çözümler sunarak, memnuniyetlerini sürekli kılmak.</li>
            <li><strong>İnovasyon ve Teknoloji:</strong> Sürekli olarak ürünlerimizi ve üretim süreçlerimizi geliştirmek, sektördeki yenilikleri takip ederek en modern çözümleri sunmak.</li>
        </ul>

        <h3 class="h5">İlkelerimiz</h3>
        <ul>
            <li><strong>Kalite:</strong> Ürünlerimizin her birini yüksek kalite standartlarına uygun olarak üretiriz. Kaliteden ödün vermeden, güvenilir ve dayanıklı çözümler sunarız.</li>
            <li><strong>Müşteri Odaklılık:</strong> Müşterilerimizin ihtiyaçlarını anlar, onlara en uygun çözümleri sunmak için çalışırız. Müşteri memnuniyeti, tüm iş süreçlerimizin merkezindedir.</li>
            <li><strong>Şeffaflık:</strong> İş ilişkilerimizde ve müşteri iletişimlerimizde daima şeffaflığı ve dürüstlüğü esas alırız.</li>
            <li><strong>Çevreye Duyarlılık:</strong> Sürdürülebilir üretim süreçleri ve çevre dostu malzemeler kullanarak, çevreye duyarlı bir yaklaşım benimseriz.</li>
